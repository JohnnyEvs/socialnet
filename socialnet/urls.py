...
urlpatterns = [
    ...
    path('posts-api/', PostFromApi.as_view(), name='posts-api'),
    path('posts-api/<int:id>/', PostDetailFromApi.as_view(), name='post-api'),
    path('todo-api-list/', TodoFromApi.as_view(), name='todo-api'),
    path('todo-detail-api/<int:id>/', TodoDetailFromApi.as_view(), name='todo-api'),
